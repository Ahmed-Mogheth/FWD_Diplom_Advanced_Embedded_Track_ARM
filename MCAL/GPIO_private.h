...
/*-------------------------------------------------------------------------------------------------------------------------------------------*/
																						/*GPIOA*/
#define GPIOA_DATA      * ((u32 *) 0x40058000)/*important read write */
#define GPIOA_DIR       * ((u32 *) 0x40058400)/*important bst5demha fe bin o/i put*/
...
#define GPIOA_DEN       * ((u32 *) 0x4005851C)/*important d/a */
...
#define GPIOB_LOCK      * ((u32 *) 0x40005420)
...
#define GPIOC_LOCK      * ((u32 *) 0x40006420)
...
#define GPIOD_LOCK      * ((u32 *) 0x40007420)
...
#define GPIOE_LOCK      * ((u32 *) 0x40007420)
...
#define GPIOF_LOCK      * ((u32 *) 0x40025420)
